...
This repo contains everything needed to create a closed loop automated way to deply Ansible Automation Platform on Azure Cloud.
...
** link:https://github.com/ansible-content-lab/azure_ansible_deployment.git[lab.azure_deployment]
* Runs `playbook` with *EE_REGISTRY_PASSWORD* and *AH_TOKEN* GitHub Secrets being passed in as Extra Vars
